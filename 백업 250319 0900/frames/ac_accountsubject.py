...
class AccountSubjectFrame(tk.Frame):
    ...
    def drawFrame(self):
        ...
        self.acInputFrameFrame.grid(row=0, column=0)
    ...
    def drawAcTable(self):
        ...
        self.acOutputFrame.grid(row=1, column=0, columnspan=2)
