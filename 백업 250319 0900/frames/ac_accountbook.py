...
class AccountBookFrame(tk.Frame):
    ...
    def drawFrame(self):
        ...
        self.bkSearchBtn = ttk.Button(self.bkCtrlFrame, text='조회하기', width=10, command=self.searchBk)
        self.bkSearchBtn.place(x=1200, y=5)

        self.bkSaveBtn = ttk.Button(self.bkCtrlFrame, text='저장하기', width=10, command=saveBk)
        self.bkSaveBtn.place(x=1200, y=32)

        self.bkApproveBtn = ttk.Button(self.bkCtrlFrame, text='승인하기', width=10, command=approval)
