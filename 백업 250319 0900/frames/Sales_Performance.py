...
class Sales_Performance(tk.Frame):
    def __init__(self, root):
        ...
        # frame 생성
        self.topleft_Frame = tk.Frame(self, width=950, height=350, bg=Color.WHITE)  # 왼쪽 위 구역
        self.topright_Frame = tk.Frame(self, width=350, height=350, bg=Color.WHITE)  # 오른쪽 위 구역
        self.bottom_Frame = tk.Frame(self, width=1300, height=350, bg=Color.WHITE)  # 아래 구역
    ...
    def create_order_form(self): # 등록
        ...
        self.performancelabel = tk.Label(self.topleft_Frame, text="판매 아이디",bg=Color.WHITE)
        self.performancelabel.grid(row=0, column=0, padx=10, pady=5, sticky="w")

        self.performanceEntry = tk.Entry(self.topleft_Frame, width=25)
        self.performanceEntry.grid(row=0, column=1, padx=10, pady=5)

        self.label2 = tk.Label(self.topleft_Frame, text="발주 코드",bg=Color.WHITE)
        ...
        self.label3 = tk.Label(self.topleft_Frame, text="내/외부",bg=Color.WHITE)
        self.label3.grid(row=2, column=0, padx=10, pady=5, sticky="w")

        self.entry3 = tk.Entry(self.topleft_Frame, width=25)
        self.entry3.grid(row=2, column=1, padx=10, pady=5)

        self.label4 = tk.Label(self.topleft_Frame, text="작성자 명",bg=Color.WHITE)
        self.label4.grid(row=3, column=0, padx=10, pady=5, sticky="w")

        self.entry4 = tk.Entry(self.topleft_Frame, width=25)
        self.entry4.grid(row=3, column=1, padx=10, pady=5)

        self.label5 = tk.Label(self.topleft_Frame, text="작성자 직책",bg=Color.WHITE)
        self.label5.grid(row=4, column=0, padx=10, pady=5, sticky="w")

        self.entry5 = tk.Entry(self.topleft_Frame, width=25)
        self.entry5.grid(row=4, column=1, padx=10, pady=5)

        self.label6 = tk.Label(self.topleft_Frame, text="작성자 연락처",bg=Color.WHITE)
        self.label6.grid(row=5, column=0, padx=10, pady=5, sticky="w")

        self.entry6 = tk.Entry(self.topleft_Frame, width=25)
        self.entry6.grid(row=5, column=1, padx=10, pady=5)

        self.label7 = tk.Label(self.topleft_Frame, text="작성자 이메일",bg=Color.WHITE)
        self.label7.grid(row=6, column=0, padx=10, pady=5, sticky="w")

        self.entry7 = tk.Entry(self.topleft_Frame, width=25)
        self.entry7.grid(row=6, column=1, padx=10, pady=5)

        self.label8 = tk.Label(self.topleft_Frame, text="관리자",bg=Color.WHITE)
        self.label8.grid(row=7, column=0, padx=10, pady=5, sticky="w")

        self.entry8 = tk.Entry(self.topleft_Frame, width=25)
        self.entry8.grid(row=7, column=1, padx=10, pady=5)

        self.label9 = tk.Label(self.topleft_Frame, text="관리자 직책",bg=Color.WHITE)
        self.label9.grid(row=8, column=0, padx=10, pady=5, sticky="w")

        self.entry9 = tk.Entry(self.topleft_Frame, width=25)
        self.entry9.grid(row=8, column=1, padx=10, pady=5)

        self.label10 = tk.Label(self.topleft_Frame, text="관리자 연락처",bg=Color.WHITE)
        self.label10.grid(row=9, column=0, padx=10, pady=5, sticky="w")

        self.entry10 = tk.Entry(self.topleft_Frame, width=25)
        self.entry10.grid(row=9, column=1, padx=10, pady=5)

        self.label11 = tk.Label(self.topleft_Frame, text="관리자 이메일",bg=Color.WHITE)
        self.label11.grid(row=10, column=0, padx=10, pady=5, sticky="w")

        self.entry11 = tk.Entry(self.topleft_Frame, width=25)
        self.entry11.grid(row=10, column=1, padx=10, pady=5)

        self.label12 = tk.Label(self.topleft_Frame, text="완제품 코드",bg=Color.WHITE)
        self.label12.grid(row=0, column=2, padx=10, pady=5, sticky="w")
        self.production_Entry=tk.Entry(self.topleft_Frame,width=25)
        self.production_Entry.grid(row=0, column=3, padx=10, pady=5)

        self.label12 = tk.Label(self.topleft_Frame, text="완제품 명",bg=Color.WHITE)
        self.label12.grid(row=1, column=2, padx=10, pady=5, sticky="w")

        self.product_name=tk.Entry(self.topleft_Frame,width=25)
        self.product_name.grid(row=1,column=3,padx=10,pady=5)


        self.label14 = tk.Label(self.topleft_Frame, text="단가",bg=Color.WHITE)
        self.label14.grid(row=2, column=2, padx=10, pady=5, sticky="w")
        self.entry14 = tk.Entry(self.topleft_Frame, width=25)
        self.entry14.grid(row=2, column=3, padx=10, pady=5)


        self.label15 = tk.Label(self.topleft_Frame, text="현 재고",bg=Color.WHITE)
        self.label15.grid(row=3, column=2, padx=10, pady=5, sticky="w")
        self.entry15 = tk.Entry(self.topleft_Frame, width=25)
        self.entry15.grid(row=3, column=3, padx=10, pady=5)

        self.label16 = tk.Label(self.topleft_Frame, text="거래 수량",bg=Color.WHITE)
        self.label16.grid(row=4, column=2, padx=10, pady=5, sticky="w")
        self.entry16 = tk.Entry(self.topleft_Frame, width=25)
        self.entry16.grid(row=4, column=3, padx=10, pady=5)

        self.label17 = tk.Label(self.topleft_Frame, text="총 가격",bg=Color.WHITE)
        self.label17.grid(row=5, column=2, padx=10, pady=5, sticky="w")
        self.entry17 = tk.Entry(self.topleft_Frame, width=25)
        self.entry17.grid(row=5, column=3, padx=10, pady=5)

        self.label18 = tk.Label(self.topleft_Frame, text="부가세",bg=Color.WHITE)
        self.label18.grid(row=6, column=2, padx=10, pady=5, sticky="w")
        self.entry18 = tk.Entry(self.topleft_Frame, width=25)
        self.entry18.grid(row=6, column=3, padx=10, pady=5)

        self.label30 = tk.Label(self.topleft_Frame, text="순 이익",bg=Color.WHITE)
        self.label30.grid(row=7, column=2, padx=10, pady=5, sticky="w")

        self.net_profit_entry = tk.Entry(self.topleft_Frame, width=25)
        self.net_profit_entry.grid(row=7,column=3,padx=10,pady=5)

        self.label19 = tk.Label(self.topleft_Frame, text="거래처 코드",bg=Color.WHITE)
        self.label19.grid(row=0, column=4, padx=10, pady=5, sticky="w")

        self.correspondent_entry = tk.Entry(self.topleft_Frame)
        self.correspondent_entry.grid(row=0, column=5, padx=10, pady=5)

        self.label20 = tk.Label(self.topleft_Frame, text="사업자 번호",bg=Color.WHITE)
        self.label20.grid(row=1, column=4, padx=10, pady=5, sticky="w")
        self.entry20 = tk.Entry(self.topleft_Frame, width=25)
        self.entry20.grid(row=1, column=5, padx=10, pady=5)

        self.label21 = tk.Label(self.topleft_Frame, text="거래처 명",bg=Color.WHITE)
        self.label21.grid(row=2, column=4, padx=10, pady=5, sticky="w")
        self.entry21 = tk.Entry(self.topleft_Frame, width=25)
        self.entry21.grid(row=2, column=5, padx=10, pady=5)

        self.label22 = tk.Label(self.topleft_Frame, text="거래처 종류",bg=Color.WHITE)
        self.label22.grid(row=3, column=4, padx=10, pady=5, sticky="w")
        self.entry22 = tk.Entry(self.topleft_Frame, width=25)
        self.entry22.grid(row=3, column=5, padx=10, pady=5)

        self.label23 = tk.Label(self.topleft_Frame, text="거래처 주소(국가)",bg=Color.WHITE)
        self.label23.grid(row=4, column=4, padx=10, pady=5, sticky="w")
        self.entry23 = tk.Entry(self.topleft_Frame, width=25)
        self.entry23.grid(row=4, column=5, padx=10, pady=5)

        self.label24 = tk.Label(self.topleft_Frame, text="거래처 담당자",bg=Color.WHITE)
        self.label24.grid(row=5, column=4, padx=10, pady=5, sticky="w")
        self.entry24 = tk.Entry(self.topleft_Frame, width=25)
        self.entry24.grid(row=5, column=5, padx=10, pady=5)

        self.label25 = tk.Label(self.topleft_Frame, text="거래처 담당자 연락처",bg=Color.WHITE)
        self.label25.grid(row=6, column=4, padx=10, pady=5, sticky="w")
        self.entry25 = tk.Entry(self.topleft_Frame, width=25)
        self.entry25.grid(row=6, column=5, padx=10, pady=5)

        self.label26 = tk.Label(self.topleft_Frame, text="거래처 담당자 이메일",bg=Color.WHITE)
        self.label26.grid(row=7, column=4, padx=10, pady=5, sticky="w")
        self.entry26 = tk.Entry(self.topleft_Frame, width=25)
        self.entry26.grid(row=7, column=5, padx=10, pady=5)

        self.label27 = tk.Label(self.topleft_Frame, text="납기일",bg=Color.WHITE)
        self.label27.grid(row=8, column=4, padx=10, pady=5, sticky="w")
        self.date_entry2 = DateEntry(self.topleft_Frame, width=22, background="#e3e3e3", foreground="white",date_pattern="yyyy-mm-dd")
        self.date_entry2.grid(row=8, column=5, padx=10, pady=5)

        self.Creation_label = tk.Label(self.topleft_Frame, text="작성 일자",bg=Color.WHITE)
        self.Creation_label.grid(row=9, column=4, padx=10, pady=5, sticky="w")
        self.date_entry1 = DateEntry(self.topleft_Frame, width=22, background="#e3e3e3", foreground="white", date_pattern="yyyy-mm-dd")
        self.date_entry1.grid(row=9, column=5, padx=10, pady=5)

        self.label28 = tk.Label(self.topleft_Frame, text="수정 일자",bg=Color.WHITE)
        self.label28.grid(row=10, column=4, padx=10, pady=5, sticky="w")
        self.date_entry3 = DateEntry(self.topleft_Frame, width=22, background="#e3e3e3", foreground="white",date_pattern="yyyy-mm-dd")
        self.date_entry3.grid(row=10, column=5, padx=10, pady=5)

        # 오른쪽 위
        self.label00 = tk.Label(self.topright_Frame, text="발주서 코드",bg=Color.WHITE)
        self.label00.grid(row=0, column=0, padx=10, pady=5, sticky="w")

        self.entry00 = tk.Entry(self.topright_Frame,width=20)
        self.entry00.grid(row=0, column=1, padx=10, pady=5)

        self.labela = tk.Label(self.topright_Frame, text="거래처 코드",bg=Color.WHITE)
        self.labela.grid(row=1, column=0, padx=10, pady=5, sticky="w")

        self.allCorrespondent_entry = tk.Entry(self.topright_Frame,width=20)
        self.allCorrespondent_entry.grid(row=1, column=1, padx=10, pady=5)

        self.labelb = tk.Label(self.topright_Frame, text="완제품 코드",bg=Color.WHITE)
        self.labelb.grid(row=2, column=0, padx=10, pady=5, sticky="w")

        self.allproduction_entry = tk.Entry(self.topright_Frame,width=20)
        self.allproduction_entry.grid(row=2, column=1, padx=10, pady=5)

        self.labelc = tk.Label(self.topright_Frame, text="작성자명",bg=Color.WHITE)
        self.labelc.grid(row=3, column=0, padx=10, pady=5, sticky="w")

        self.allAuthor_entry = tk.Entry(self.topright_Frame,width=20)
        self.allAuthor_entry.grid(row=3, column=1, padx=10, pady=5)

        self.labeld = tk.Label(self.topright_Frame, text="관리자명",bg=Color.WHITE)
        self.labeld.grid(row=4, column=0, padx=10, pady=5, sticky="w")

        self.administrator_entry = tk.Entry(self.topright_Frame,width=20)
        self.administrator_entry.grid(row=4, column=1, padx=10, pady=5)

        self.label31=tk.Label(self.topright_Frame, text="담당자명",bg=Color.WHITE)
        self.label31.grid(row=5, column=0, pady=5, padx=10, sticky="w")
        self.allmanager_entry = tk.Entry(self.topright_Frame,width=20)
        self.allmanager_entry.grid(row=5, column=1, pady=5, padx=10)

        # DateEntry에 대한 열 크기 조정
        self.topright_Frame.columnconfigure(1, weight=4, uniform="equal")  # column 1에 비례적으로 공간 분배
        self.topright_Frame.columnconfigure(2, weight=4, uniform="equal")  # column 2에도 동일하게 적용

        # 왼쪽 위
        self.labele = tk.Label(self.topright_Frame, text="납기일별",bg=Color.WHITE)
        self.labele.grid(row=6, column=0, padx=10, pady=5, sticky="w")

        self.date_entry4 = DateEntry(self.topright_Frame, width=40, background="#e3e3e3", foreground="white",date_pattern="yyyy-mm-dd")
        self.date_entry4.grid(row=6, column=1, padx=10, pady=5, sticky="nsew")
        # 선택하면 DateEntry에 표시만 됌 실제로 가져오는 건 따로

        self.date_entry5 = DateEntry(self.topright_Frame, width=40, background="#e3e3e3", foreground="white",date_pattern="yyyy-mm-dd")
        self.date_entry5.grid(row=6, column=2, padx=10, pady=5, sticky="nsew")

        self.labelf = tk.Label(self.topright_Frame, text="작성일자별",bg=Color.WHITE)
        self.labelf.grid(row=7, column=0, padx=10, pady=5, sticky="w")

        self.date_entry6 = DateEntry(self.topright_Frame, width=30, background="#e3e3e3", foreground="white",date_pattern="yyyy-mm-dd")
        self.date_entry6.grid(row=7, column=1, padx=10, pady=5, sticky="nsew")

        self.date_entry7 = DateEntry(self.topright_Frame, width=30, background="#e3e3e3", foreground="white",date_pattern="yyyy-mm-dd")
        self.date_entry7.grid(row=7, column=2, padx=10, pady=5, sticky="nsew")


        self.labelg = tk.Label(self.topright_Frame, text="수정 일자별",bg=Color.WHITE)
        ...
        self.date_entry8.grid(row=8, column=1, padx=10, pady=5,sticky="nsew")

        self.date_entry9 = DateEntry(self.topright_Frame, width=30, background="#e3e3e3", foreground="white",date_pattern="yyyy-mm-dd")
        self.date_entry9.grid(row=8, column=2, padx=10, pady=5,sticky="nsew")

        self.btn_search = tk.Button(self.topright_Frame, text="조회", command=self.select_performance, bg=Color.WHITE)
        self.btn_search.grid(row=0, column=3, padx=10, pady=5, sticky="e")
    ...
    #         'NetProfit', 'Customer_code', 'business_number', 'account_name', 'account_type', 'account_address',
    #         'account_manager', 'manager_phone', 'manager_email', 'delivery_date', 'creation_date', 'modified_date'
    #     ]
    #
    ...
    #                 if start_value:
    #                     if isinstance(start_value, datetime.datetime):  # datetime 객체 처리
    #                         start_value = start_value.strftime('%Y-%m-%d')
    #                     if start_value != datetime.datetime.now().strftime('%Y-%m-%d'):  # 오늘 날짜가 아니면 조건 추가
    ...
    #                 if end_value:
    #                     if isinstance(end_value, datetime.datetime):  # datetime 객체 처리
    #                         end_value = end_value.strftime('%Y-%m-%d')
    #                     if start_value == end_value:
    #                         # start와 end 값이 같으면 조건을 추가하지 않음
    #                         print("start와 end 날짜가 같음. 조건을 추가하지 않습니다.")
    #                         continue  # 두 날짜가 같으면 조건 추가 안 함
    #                     conditions.append(f"{column_name} <= '{end_value} 23:59:59'")
    #                     print('conditions end 처리:', conditions)
    #
    #             # 일반적인 값 비교 처리
            ...
            if isinstance(data, list) and len(data) > 0:
                if any(data[0]):
                    ...
                    self.table = TableWidget(self.bottom_Frame,
                                             data=data,
                                             col_name=["판매 실적 아이디", "발주 코드", "내/외부 여부", "작성자명", "작성자 직책", "작성자 연락처",
                    ...
                    # value16 = data[0][16]  # 예시: data[0][16]이 첫 번째 값
                    # value17 = data[0][17]  # 예시: data[0][17]이 두 번째 값 (부가세)
                    # net_profit = value16 - value17
                ...
                msgbox.showerror("조회 오류2", "조회된 데이터가 없습니다.")
