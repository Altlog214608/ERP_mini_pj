...
class TableWidget(tk.Frame):
    def __init__(self, master, padding=0, data=None, cols=0, new_row=True, has_checkbox=True, col_name=None,
        ...
        self.row_count = (self.height - self.origin_cell_height - self.scrollbar_width) // self.cell_height  # canvas에 보여질 행 개수
    ...
    def from_data(self, data, cols = 0, new_row = True, has_checkbox = True,
        ...
        self.row_count = (self.height - self.origin_cell_height * self.col_name.rows - self.scrollbar_width) // self.cell_height  # canvas에 보여질 행 개수
    ...
    def draw_table(self):
        ...
        # 좌상단 셀
        self.canvas.create_rectangle(0, 0, self.origin_cell_width, self.origin_cell_height * self.col_name.rows, outline=Color.BLACK, fill=Color.FOCUS, tags="header")

        # 체크박스 열
        if self.has_checkbox:
            self.canvas.create_rectangle(self.origin_cell_width, 0, self.origin_cell_width + self.checkbox_cell_width, self.origin_cell_height * self.col_name.rows, outline=Color.BLACK, fill=Color.FOCUS, tags="header")
